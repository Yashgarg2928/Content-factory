...
def blur_with_glow(clip, blur_intensity=300, glow_intensity=1.2):
...
def glow_effect(clip, glow_intensity=1.4):
    """
...
def editor(csv_path, output_path, path, words, srt_file, audio_path = None):
    ...
    for idx, i in enumerate(effect_videos[1:]):
        ...
        if t == 'cross_dissolve':
            ...
            transition_video = cross_dissolve(transition_video, i, duration = 0.3)
